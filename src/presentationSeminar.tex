...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north east, xshift=-5.2cm, yshift=-2.1cm] at (current page.north east) {%
    \begin{minipage}{0.5\textwidth}
    \small Error in Noise
...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north east, xshift=-8.5cm, yshift=-2.4cm]
...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north east, xshift=-6cm, yshift=-6.4cm] at (current page.north east) {%
    \begin{minipage}{0.5\textwidth}
    \scriptsize ($\approx 10^{11}$ DOF for $10^{-3}$ error)
...
\begin{frame}[t]{Augmented Burgers System}
  ...
  \begin{itemize}
    ...
    \item It is typically solved with a time-marching scheme.
  \end{itemize}
  }
\end{frame}
...
% \stepcounter{sectionframecount}
% \begin{frame}[t]{Space-time Adaptive Method}
...
% \begin{minipage}[t]{1\linewidth}
%   \vspace{4.8cm}
%   But, space-time unstructured requires solving an optimization problem for the mesh.
% \end{minipage}
% }
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north east, xshift=-1.3cm, yshift=-3.2cm] at (current page.north east) {%
    \begin{minipage}{0.5\textwidth}
    \small Output error
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  at (current page.north east) {\includegraphics[height=5.5cm]{../figs/shock_capturing/OutputErrorTravelingWave_Consistent_adaptive.pdf}};
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  at (current page.north east) {\includegraphics[height=5.8cm]{../figs/SBW3results/sbw3_P1_128K_P_lines.png}};
\end{tikzpicture}

\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north east, xshift=0.2cm, yshift=-2cm]
  at (current page.north east) {\includegraphics[height=5.8cm]{../figs/SBW3results/sbw3_P1_128K_P_field.png}};

  \node[anchor=south west, font=\scriptsize, black, xshift=83mm, yshift=8mm] at (img.north west) {Ground};

  \node[anchor=south west, font=\scriptsize, black, xshift=83mm, yshift=-50mm] at (img.north west) {Nearfield};
\end{tikzpicture}
...
\stepcounter{sectionframecount}
\begin{frame}[t]{Sonic Boom Carpet: Front View}
