...
\begin{frame}[t]{Solution Approach: Broad Picture}
  ...
  \begin{minipage}[t]{1\linewidth}
    ...
    \tikz [remember picture,baseline] \node (start3) {}; $\dfrac{d(\text{Noise})}{dX} = \dfrac{\partial (\text{Noise})}{\partial p_{nf}} \dfrac{d p_{nf}}{d X}$ \tikz [remember picture,baseline] \node (end3) {};.
  \end{minipage}
  ...
  \vspace{-35pt}\footnotetext{D. L. Rodriguez et. al. 2025}
\end{frame}
...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north east, xshift=-5.2cm, yshift=-2cm] at (current page.north east) {%
...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=north east, xshift=0cm, yshift=-2cm] at (current page.north east) {%
    \begin{minipage}{0.5\textwidth}
    \small Error in $|\partial (\text{Noise})/\partial p_{nf}|$
...
\begin{frame}[t]{Shock Indicator $s_{\text{grad}}$}
  ...
  \end{equation}
  \begin{tikzpicture}[remember picture,overlay]
    \node[anchor=north east, xshift=-2.5cm, yshift=-3.3cm]
